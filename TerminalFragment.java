...
import static de.kai_morich.simple_usb_terminal.MainActivity.dataPayload;
import static de.kai_morich.simple_usb_terminal.MainActivity.offset;
import static de.kai_morich.simple_usb_terminal.MainActivity.vtuId;
...
public class TerminalFragment extends Fragment implements ServiceConnection, SerialListener {
    ...
    private void receive(ArrayDeque<byte[]> datas) {
        ...
        String msg2 = spn.toString();
        //added for VTU100
        if (msg2.startsWith("TL") && msg2.contains("#"))
            push2main(msg2);
        if (msg2.startsWith("SL") && msg2.length()==15)
            push2main(msg2);
        receiveText.append(spn);
    }

    private void push2main(String msg2) {
        //if(msg2.length()>15) {
        //if (msg2.startsWith("TL") && msg2.contains("#"))

            //Toast.makeText(getActivity(), "MSG2 : " + msg2 , Toast.LENGTH_SHORT).show();
            // checked found corrected ✅
            //MSG2 : TL6RkXV1hN4NR24jR60fR85aG20#17>-52

            vtuId = msg2.substring(0,11);
            int hashIndex = msg2.indexOf('#');
            dataPayload = msg2.substring(10, hashIndex);
            int hash2 = msg2.indexOf('>');
            offset = Integer.parseInt(msg2.substring(hashIndex + 1, hash2));
            //Toast.makeText(getActivity(), "ID: " + vtuId + " PL: " + datapayload + " Off: " + offset, Toast.LENGTH_SHORT).show();
            // checked found corrected ✅
            //ID: TL6RkXV1hN4 PL:4NR24jR60fR85aG20 Off: 17
    }
